...
class CheckInTruckListFragment : BaseFragmentWithViewModel<CheckInTruckListViewModel, FragmentTruckListBinding>(),
    ...
    override fun onResume() {
        super.onResume()
        changeFragmentTitle(getString(R.string.check_in_truck_list),requireActivity() as MainActivity)
    ...
    override fun onTruckItemClicked(truck: Vehicle) {
        ...
        findNavController().navigate(R.id.action_checkInTruckListFragment_to_checkInFragment,bundle)
    }
}