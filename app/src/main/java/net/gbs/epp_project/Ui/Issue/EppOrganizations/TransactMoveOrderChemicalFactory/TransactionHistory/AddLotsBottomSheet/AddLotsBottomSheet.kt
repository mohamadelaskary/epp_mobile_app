package net.gbs.epp_project.Ui.Issue.EppOrganizations.TransactMoveOrderChemicalFactory.TransactionHistory.AddLotsBottomSheet
        ...
        binding.add.setOnClickListener {
            ...
            if (selectedLot!=null) {
                if (validQty(enteredQty)) {
                    lotQtyList.add(
                        LotQty(
                            locatorId = locatorFrom?.locatorId.toString(),
...
//                }
    ...
    private fun clearLotData() {
        ...
        binding.remainingQty.text = remainingQty.toString()
        binding.lotQty.editText?.setText(remainingQty.toString())
        binding.lotQty.error = null
        binding.lotNumber.error = null
    }
    ...
    override fun onStart() {
        ...
        Log.d(TAG, "onStart: ${lotList.size}")
    }
